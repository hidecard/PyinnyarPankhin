                    ...
                    <form action="{{ route('admin.degrees.update', $degree) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('level') is-invalid @enderror"
                                ...
                                <option value="undergraduate" {{ old('level', $degree->level) == 'undergraduate' ? 'selected' : '' }}>Undergraduate</option>
                                <option value="masters" {{ old('level', $degree->level) == 'masters' ? 'selected' : '' }}>Masters</option>
                                <option value="doctoral" {{ old('level', $degree->level) == 'doctoral' ? 'selected' : '' }}>Doctoral</option>
                            </select>
