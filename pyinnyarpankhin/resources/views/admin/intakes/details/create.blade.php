        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="color: #6C3428;">Add Intake Detail for {{ $intake->name }}</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.intakes.intakes.details.store', $intake) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('admin.intakes.intakes.details.index', $intake) }}" class="btn btn-secondary">
