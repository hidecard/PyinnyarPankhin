        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" style="color: #6C3428;">Edit Intake Detail for {{ $intake->name }}</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.intakes.intakes.details.update', [$intake, $detail]) }}" method="POST">
                        @csrf
                        @method('PUT')
